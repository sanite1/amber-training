...
import footerlogo from "../assets/images/amberLogo.png";
      ...
      >
        <Grid container>
          ...
          <Grid item xs={12} md={4} sx={{ mt: { xs: 0, md: 13 } }}>
            ...
            <Divider
              width="80%"
              sx={{ height: "2px", backgroundColor: "#A81F24", mt: 2, mb: 2 }}
            />
            <Box>
        ...
        >
          Copyright © {new Date().getFullYear()}. Amber Training. All rights
          reserved.
        </Typography>
      </Box>
    </>
